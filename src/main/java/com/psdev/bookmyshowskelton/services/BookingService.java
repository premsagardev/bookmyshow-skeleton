...
import com.psdev.bookmyshowskelton.exceptions.ShowNotFoundException;
import com.psdev.bookmyshowskelton.exceptions.ShowSeatNotAvailableException;
import com.psdev.bookmyshowskelton.exceptions.UserNotFoundException;
import com.psdev.bookmyshowskelton.models.*;
import com.psdev.bookmyshowskelton.repositories.BookingRepository;
import com.psdev.bookmyshowskelton.repositories.ShowRepository;
import com.psdev.bookmyshowskelton.repositories.ShowSeatRepository;
...
public class BookingService { //@Service //@Controller //@Repository //@Component
    ...
    public Booking bookMovie(Long userId, Long showId, List<Long> showSeatIds) {
        ...
        //3. Get the list of showSe  ats from showSeatIds.
